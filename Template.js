...
(function(window) {
    (function(implementacao) {
        if (typeof define === "function" && define.amd) {
            define(["jquery"], implementacao);
        } else {
            window.Template = implementacao(window.jQuery);
        }
    })(function(jQuery) {
            ...
            Template.prototype = {
                ...
                renderizar: function(parametros) {
                    var $resultados = $(document.createDocumentFragment()),
                        vetObjDados = parametros.dados,
                        aCadaLinha = parametros.aCadaLinha,
